...
const SagittariusGuideContent = () => {
  ...
  const skillImages: { [key: string]: string } = {
    ...
    "Winter Runner": "speed.png",
    "Nakayama Racecourse": "stam.png",
      ...
      <div>
        ...
        <div className="mb-8">
          <p className="text-body-color mb-3 text-2xl font-medium sm:text-3xl">
            <strong className="text-black dark:text-white">Track:</strong> Nakayama 1600m (clockwise)
          </p>
          <p className="text-body-color mb-3 text-2xl font-medium sm:text-3xl">
            <strong className="text-black dark:text-white">Distance:</strong> Mile
          </p>
        </div>
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
          {[
            "Right-Handed", "Non-Standard Distance", "Winter Runner", "Nakayama Racecourse",
            "Firm Conditions", "Sunny Days", "Outer Post Proficiency (RNG)",
            "Maverick (RNG)", "Long Shot (RNG)", "Lone Wolf (RNG)", "Target In Sight (RNG)",
            "Inner Post Proficiency (RNG)", "Lucky Seven (RNG)", "Sympathy (RNG)", "Competitive Spirit"
          ].map((skill, index) => (
...
export default SagittariusGuideContent;
